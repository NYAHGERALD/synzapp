...
export const env = {
  ...
  openAiInterpreterTranscriptionModel: process.env.OPENAI_INTERPRETER_TRANSCRIPTION_MODEL || 'gpt-4o-mini-transcribe',
  openAiInterpreterSegmentModel: process.env.OPENAI_INTERPRETER_SEGMENT_MODEL || process.env.OPENAI_INTERPRETER_SUMMARY_MODEL || process.env.OPENAI_MODEL || 'gpt-4.1-mini',
