...
function ChatNotificationSettingsModal({
  chat,
  isLoading,
  isOpen,
  isSaving,
...
function isChatUnavailableForCurrentUserError(error: unknown): boolean {
  return error instanceof Error &&
...
function getAddableContactsForGroup(
  chat: ChatItem,
  directContacts: ChatContact[],
  currentUid: string
): ChatContact[] {
